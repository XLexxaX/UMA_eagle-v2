...
public class Controller {
    ...
    private static int maxRounds = 75;
...
//            System.exit(0);
           ...
           // SimpleServer.startServer(port, limit);
            ...
            config.maxRounds = maxRounds;
           	ResultMappings mappings = getMapping(config, new GoldStandardBatchReader("C:/Users/Alexander/Desktop/data_phones/alignment.nt"));
          	writeResults(mappings, config);
        }
    }
    public TrainTestResults run(String[] args, int maxRounds, double acceptanceThreshold) {
...
//            System.exit(0);
        ...
        GoldStandardBatchReader gsbr = new GoldStandardBatchReader("C:/Users/Alexander/Desktop/data_phones/alignment.nt"); //new GoldStandardBatchReader("B:/Development/limes2/limes/limes-core/src/main/resources/datasets/dbpedia-linkedmdb/reference2.nt");//new GoldStandardBatchReader("B:/Development/limes2/limes/limes-core/src/main/resources/datasets/dailymed-drugbank-ingredients/reference2.nt");
        ...
        if (isAlgorithm) {
            try {
                results = MLPipeline.execute(sourceCache, targetCache, config, config.getMlAlgorithmName(),
                        ...
                        config.getTrainingDataFile(), config.getMlPseudoFMeasure(), MAX_ITERATIONS_NUMBER, config.maxRounds, gsbr);
