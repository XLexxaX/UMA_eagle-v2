...
public class ActiveMLAlgorithm extends AMLAlgorithm {
     ...
     * @throws UnsupportedMLImplementationException if ML implementation is not supported
     */
    public AMapping getNextExamples(int size, GoldStandardBatchReader gsbr) throws UnsupportedMLImplementationException {
        return getMl().getNextExamples(size, gsbr);
    }
